...
PROJ.exclude = %w(tmp$ bak$ ~$ CVS .svn/ ^pkg/ ^doc/ ^\. ^rails-example/)
...
rakefiles = Dir.glob('build_tasks/*.rake').sort
rakefiles.unshift(rakefiles.delete('build_tasks/post_load.rake')).compact!
import(*rakefiles)
