Event.observe(window, 'load', function() {
  ...
  new Insertion.Top(document.body, "<div id='tuneup'><a id='tuneup-logo' href=''><img src='/images/tuneup/logo.gif' alt='TuneUp'/></a><div id='tuneup-content'></div></div><div id='tuneup-flash'></div>");
